...
We edit all of these raw data to `.csv` file to impleament in our project. You can find all data file in `/data` folder or using `cd data` in terminal.
